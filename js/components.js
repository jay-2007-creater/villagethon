...
const UIComponents = {
  ...
  renderGoogleAuthChooserModal(accounts = []) {
    ...
    return `
      ...
      <!-- Real Google Popup Trigger via Firebase -->
      <button type="button" onclick="AuthEngine.triggerGoogleSignIn()" style="width:100%; display:flex; align-items:center; justify-content:center; gap:10px; background:#FFFFFF; border:2px solid #4285F4; color:#1E293B; font-weight:800; font-size:0.92rem; padding:12px; border-radius:14px; margin-bottom:12px; cursor:pointer; box-shadow:0 2px 6px rgba(66,133,244,0.15);">
        ...
        <span>Open Official Google Account Popup 🌐</span>
      </button>

      <div style="font-size:0.75rem; font-weight:800; color:#94A3B8; text-transform:uppercase; text-align:center; margin-bottom:10px; letter-spacing:0.5px;">— Or Choose Below —</div>
