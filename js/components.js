...
const UIComponents = {
  ...
  renderGoogleAuthChooserModal(accounts = []) {
    ...
    return `
      ...
      <!-- Quick 1-Tap Login as Siddhant -->
      <button type="button" onclick="AuthEngine.selectGoogleAccount('siddhantramteke06@gmail.com')" style="width:100%; display:flex; align-items:center; justify-content:center; gap:10px; background:#F0FDF4; border:2px solid #22C55E; color:#15803D; font-weight:800; font-size:0.92rem; padding:12px; border-radius:14px; margin-bottom:14px; cursor:pointer; box-shadow:0 2px 6px rgba(34,197,94,0.15);">
        <span>⭐ Sign In as Siddhant Ramteke 🚀</span>
      </button>

      <div style="font-size:0.75rem; font-weight:800; color:#94A3B8; text-transform:uppercase; text-align:center; margin-bottom:10px; letter-spacing:0.5px;">— Or Choose Account Below —</div>
      ...
      <div style="background:#F8FAFC; border:1.5px solid #CBD5E1; border-radius:16px; padding:12px 14px; margin-bottom:14px;">
        <div style="font-weight:800; color:#1E293B; font-size:0.85rem; margin-bottom:8px; display:flex; align-items:center; gap:6px;">
          <span>🌐</span> Connect Another Gmail Account
        </div>
