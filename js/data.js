...
const CityData = {
  ...
  municipalNotices: [
    // --- TALEGAON DABHADE MUNICIPAL COUNCIL (TAL-TDMC) ---
    {
      id: "NOTICE-TAL-101",
      municipalityId: "TAL-TDMC",
      municipalityName: "Talegaon Dabhade Municipal Council",
      title: "Scheduled Indrayani Water Works Valve Maintenance - Low Pressure Alert",
      category: "water",
      categoryLabel: "💧 Water Supply",
      priority: "high",
      date: "17 Sep 2026",
      time: "09:30 AM",
      effectiveSchedule: "Friday, 18 Sep 2026 • 10:00 AM – 04:00 PM",
      targetWard: "Ward 2 (Samta Colony) & Ward 3 (Jijamata Chowk)",
      author: "Er. Suresh Deshmukh",
      designation: "Executive Water Works Engineer, TDMC",
      officialSeal: "TDMC Water Works & Pipeline Division",
      body: "Essential express sluice valve replacement and sediment flush is scheduled at Indrayani Headworks. Tap water pressure will remain low throughout Samta Colony, Shivaji Nagar, and Jijamata Chowk. Citizens are requested to store adequate drinking water. Emergency water tankers are placed on standby at 02114-222123.",
      helpline: "02114-222123",
      isPinned: true
    },
    {
      id: "NOTICE-TAL-102",
      municipalityId: "TAL-TDMC",
      municipalityName: "Talegaon Dabhade Municipal Council",
      title: "Special Pre-Monsoon Dengue & Malaria Thermal Fogging Campaign",
      category: "health",
      categoryLabel: "🏥 Health & Fogging",
      priority: "normal",
      date: "16 Sep 2026",
      time: "04:15 PM",
      effectiveSchedule: "18 Sep – 21 Sep 2026 • 06:30 AM & 06:00 PM",
      targetWard: "All Wards (Entire Talegaon Dabhade)",
      author: "Dr. K. N. Patil",
      designation: "Chief Medical Health Officer, TDMC",
      officialSeal: "TDMC Public Health Division",
      body: "High-capacity thermal fogging and anti-larval spraying squads will operate door-to-door across all residential colonies. Please keep domestic overhead and ground water containers covered and allow vector control squads access to open gutters.",
      helpline: "1800-233-0244",
      isPinned: false
    },
    {
      ...
      municipalityId: "TAL-TDMC",
      municipalityName: "Talegaon Dabhade Municipal Council",
      title: "Station Road Asphalt Resurfacing & Single-Lane Traffic Diversion",
      category: "roads",
      categoryLabel: "🚧 Road Works",
      priority: "high",
      date: "15 Sep 2026",
      time: "11:00 AM",
      effectiveSchedule: "19 Sep – 22 Sep 2026 • Night Hours (10 PM - 05 AM)",
      targetWard: "Ward 1 (Station Road & Railway Bazaar)",
      author: "Rajendra Kulkarni",
      designation: "Town Engineer (Public Works), TDMC",
      officialSeal: "TDMC PWD & Infrastructure Dept",
      body: "Milling and bituminous asphalt top layer laying between Talegaon Railway Station and Maruti Mandir. Heavy transport vehicles are requested to detour via Old Mumbai-Pune Highway service bypass road.",
      helpline: "02114-222123",
      isPinned: false
    },
    {
      ...
      municipalityId: "TAL-TDMC",
      municipalityName: "Talegaon Dabhade Municipal Council",
      title: "Mega Swachhata & Electronic Waste Collection Drive This Sunday",
      category: "sanitation",
      categoryLabel: "♻️ Waste & Sanitation",
      priority: "normal",
      date: "14 Sep 2026",
      time: "02:00 PM",
      effectiveSchedule: "Sunday, 20 Sep 2026 • 08:00 AM – 01:00 PM",
      targetWard: "Ward 2 (Municipal Garden) & Ward 3",
      author: "Prakash Deshmukh",
      designation: "Chief Municipal Officer (CMO), TDMC",
      officialSeal: "TDMC Solid Waste Management Dept",
      body: "Hand over broken appliances, old cables, laptops, tube-lights, and dry recyclables at the mobile collection kiosk near Jijamata Chowk. Earn 50 bonus Eco-Points per kg deposited directly into your CityAssist citizen wallet.",
      helpline: "1800-233-0244",
      isPinned: false
    },
    ...
    // --- PUNE MUNICIPAL CORPORATION (MH-PMC) ---
    {
      ...
      title: "Parvati Water Works Pumping Station Electrical Overhaul Alert",
      category: "water",
      categoryLabel: "💧 Water Supply",
      priority: "urgent",
      date: "17 Sep 2026",
      time: "08:00 AM",
      effectiveSchedule: "Saturday, 19 Sep 2026 • Whole Day Closure",
      targetWard: "Zone 1 (Shivajinagar) & Zone 2 (Kothrud)",
      author: "Nandkishor Jagtap",
      designation: "Chief Engineer (Water Supply), PMC",
      officialSeal: "PMC Water Works Division",
      body: "High-voltage transformer inspection and impeller pump replacement at Parvati and Cantonment Water Works. Tap water supply will remain completely shut on Saturday across Shivajinagar, Kothrud, Deccan, and Karve Nagar. Supply resumes Sunday morning with low pressure.",
      helpline: "1800-103-0222",
      isPinned: true
    },
    {
      ...
      municipalityId: "MH-PMC",
      municipalityName: "Pune Municipal Corporation",
      title: "Mutha Riverfront Sump Desilting & Stormwater Preparedness",
      category: "sanitation",
      categoryLabel: "♻️ Waste & Sanitation",
      priority: "normal",
      date: "16 Sep 2026",
      time: "01:30 PM",
      effectiveSchedule: "Ongoing • 15 Sep – 25 Sep 2026",
      targetWard: "Zone 3 (Aundh, Baner) & Zone 1",
      author: "Dr. Kunal Khemnar (IAS)",
      designation: "Additional Municipal Commissioner, PMC",
      officialSeal: "PMC Drainage & Disaster Management",
      body: "Mechanized suction jetting machines deployed along riverside causeways to prevent waterlogging. Residents are requested not to discard construction debris or plastic bags into natural stormwater channels.",
    ...
    // --- PIMPRI CHINCHWAD MUNICIPAL CORPORATION (MH-PCMC) ---
    {
      id: "NOTICE-PCMC-301",
      municipalityId: "MH-PCMC",
      municipalityName: "Pimpri Chinchwad Municipal Corporation",
      title: "Bhakti Shakti Flyover Structural Lighting & Feeder Line Inspection",
      category: "urgent",
      categoryLabel: "⚡ Electrical & Works",
      priority: "high",
      date: "17 Sep 2026",
      time: "10:15 AM",
      effectiveSchedule: "Tonight, 17 Sep 2026 • 11:30 PM – 04:30 AM",
      targetWard: "Ward 1 (Nigdi & Pradhikaran Division)",
      author: "Sanjay Kulkarni",
      designation: "Chief Environmental & Electrical Engineer, PCMC",
      officialSeal: "PCMC Electrical & Infrastructure Dept",
      body: "Routine maintenance and high-mast streetlight luminaire replacement on Nigdi Flyover. Light vehicles will be channeled through grade service road.",
      helpline: "1800-103-5651",
      isPinned: false
    },
    {
      id: "NOTICE-PCMC-302",
      municipalityId: "MH-PCMC",
      municipalityName: "Pimpri Chinchwad Municipal Corporation",
      title: "Zero Waste Housing Society Cleanliness Award 2026 Nominations",
      category: "general",
      categoryLabel: "📢 Circulars",
      priority: "normal",
      date: "15 Sep 2026",
      time: "03:00 PM",
      effectiveSchedule: "Nominations Open Till 30 Sep 2026",
      targetWard: "All Wards (PCMC Citywide)",
      author: "Shekhar Singh (IAS)",
      designation: "Municipal Commissioner, PCMC",
      officialSeal: "PCMC Swachh Survekshan Cell",
      body: "Housing societies practicing 100% in-situ wet waste composting and rooftop solar are invited to apply for the Mayor's Green Society Trophy with up to 10% property tax rebate.",
      helpline: "020-67333333",
      isPinned: false
    },
    ...
    // --- BRIHANMUMBAI MUNICIPAL CORPORATION (MH-BMC) ---
    {
      id: "NOTICE-BMC-401",
      municipalityId: "MH-BMC",
      municipalityName: "Brihanmumbai Municipal Corporation",
      title: "High Tide Warning (4.82m) & Coastal Safety Advisory",
      category: "urgent",
      categoryLabel: "🚨 Emergency Alert",
      priority: "urgent",
      date: "17 Sep 2026",
      time: "07:00 AM",
      effectiveSchedule: "18 Sep 2026 • 01:45 PM – 04:30 PM",
      targetWard: "Ward A (Colaba, Fort) & Marine Lines",
      author: "Disaster Management Cell, BMC",
      designation: "Director of Disaster Management, BMC",
      officialSeal: "BMC Disaster Control Headquarters",
      body: "Extremely high tide forecasted coinciding with coastal convective showers. Citizens are strongly advised to avoid promenades at Marine Drive, Worli Seaface, Dadar Chowpatty, and Juhu Beach.",
      helpline: "1916",
      isPinned: true
    },

    // --- NAGPUR MUNICIPAL CORPORATION (MH-NMC) ---
    {
      id: "NOTICE-NMC-501",
      municipalityId: "MH-NMC",
      municipalityName: "Nagpur Municipal Corporation",
      title: "Early Bird Property Tax 10% Concession Deadline Alert",
      category: "general",
      categoryLabel: "📢 Circulars",
      priority: "normal",
      date: "16 Sep 2026",
      time: "11:00 AM",
      effectiveSchedule: "Last Date: 30 September 2026",
      targetWard: "All Zones (Dharampeth, Laxmi Nagar & Hanuman Nagar)",
      author: "Milind Meshram",
      designation: "Deputy Municipal Commissioner (Revenue), NMC",
      officialSeal: "NMC Assessment & Collection Dept",
      body: "Pay your current year civic property and water cess before 30 September to avail 10% special rebate on principal tax amount. Payment portals available online 24x7.",
      helpline: "1800-233-3764",
      isPinned: false
    }
  ]
